#!/usr/bin/env bash
# ParallelHue client for the local GLM-5.3 Flash serve (2x RTX PRO 6000).
# Assumes the recipe serve is ALREADY listening on 127.0.0.1:8000
# (vLLM, model glm-5.3-flash-local, MAX_NUM_SEQS=16) — this script does NOT
# launch vLLM. One command → tmux session with N panes → live colored streams.
#
