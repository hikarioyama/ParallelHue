#!/usr/bin/env bash
# Shared ParallelHue launcher body for Maple-Preview TQ2 examples.
# Sourced by run-c8.sh / run-c16.sh after setting CONCURRENCY default.
set -euo pipefail
...
#   PARALLELHUE_FREQUENCY_PENALTY= PARALLELHUE_REPEAT_PENALTY= ./run-c16.sh
